...
abstract class RencentChatMiddlewareAction
    implements
        Built<RencentChatMiddlewareAction, RencentChatMiddlewareActionBuilder>,
        AbstractRecentMess {
  ...
  factory RencentChatMiddlewareAction(
...
abstract class RencentChatReducerAction
    implements
        Built<RencentChatReducerAction, RencentChatReducerActionBuilder>,
        AbstractRecentMess {
  RencentChatReducerAction._();
  BuiltList<RecentMessage> get recentMess;
  factory RencentChatReducerAction.create(
          {required BuiltList<RecentMessage> newMess}) =>
      RencentChatReducerAction(
          (update) => update..recentMess = ListBuilder(newMess));
  factory RencentChatReducerAction(
